  ...
  return {
    plugins: [
      ...
      VitePWA({
        ...
        manifest: {
          id: '/',
          name: 'CAST StoreMidia - Mídia Indoor & Painel de Chamadas',
          short_name: 'CAST StoreMidia',
          description: 'Sistema completo de gerenciamento e exibição de mídia indoor CAST StoreMidia com chamadas e playlists em tempo real.',
          theme_color: '#0f172a',
