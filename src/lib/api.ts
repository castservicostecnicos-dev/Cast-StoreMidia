...
// Suporte a API_BASE para ambientes Cloudflare Pages, Workers ou hospedagem desacoplada
export const API_BASE = (import.meta.env.VITE_API_URL || '').replace(/\/$/, '');

/**
 * Normaliza URLs de mídias (vídeos, imagens) para funcionar tanto em
 * ambiente local/servidor único quanto com frontend no Cloudflare Pages.
 */
