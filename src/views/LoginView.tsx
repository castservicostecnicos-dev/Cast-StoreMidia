    ...
    <div className="flex min-h-screen flex-col justify-center items-center px-4 py-12 sm:px-6 lg:px-8 bg-slate-900">
      <div className="w-full max-w-md space-y-6">
        ...
        <div className="text-center">
          ...
          <h1 className="mt-4 text-2xl font-bold tracking-tight text-white uppercase sm:text-3xl">CAST StoreMidia</h1>
          <p className="mt-1 text-xs tracking-wider text-slate-400 uppercase">Sistema de Gestão de Mídia Indoor & Painel de Chamadas</p>
        </div>
